...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'authLoadWorkers',
    sectionId: 'network',
    labelKey: L('sections.network.auth_load_workers'),
    hintKey: L('sections.network.auth_load_workers_hint'),
    yamlKeys: ['auth-load-workers'],
  },
  {
  ...
  {
    fieldId: 'deleteUnauthorizedAuth',
    sectionId: 'network',
    labelKey: L('sections.network.delete_unauthorized_auth'),
    hintKey: L('sections.network.delete_unauthorized_auth_desc'),
    yamlKeys: ['delete-unauthorized-auth'],
  },
  {
  ...
  },
  {
    ...
    sectionId: 'network',
    labelKey: L('sections.network.transient_error_cooldown'),
    hintKey: L('sections.network.transient_error_cooldown_hint'),
    yamlKeys: ['transient-error-cooldown-seconds'],
  },
  {
    fieldId: 'localModel',
    sectionId: 'network',
    labelKey: L('sections.network.local_model'),
    hintKey: L('sections.network.local_model_desc'),
    yamlKeys: ['local-model'],
  },
  {
    fieldId: 'videoResultAuthCacheTtl',
    sectionId: 'network',
    labelKey: L('sections.network.video_result_auth_cache_ttl'),
    hintKey: L('sections.network.video_result_auth_cache_ttl_hint'),
    yamlKeys: ['video-result-auth-cache-ttl'],
  },
  {
  ...
  },
  {
    ...
    sectionId: 'network',
    labelKey: L('sections.network.session_affinity_subagents'),
    hintKey: L('sections.network.session_affinity_subagents_desc'),
  ...
  {
    fieldId: 'usagePersistenceEnabled',
    sectionId: 'logging',
    labelKey: L('sections.system.usage_persistence_enabled'),
    hintKey: L('sections.system.usage_persistence_enabled_desc'),
    yamlKeys: ['usage-persistence-enabled'],
  },
  {
    fieldId: 'requestLog',
    sectionId: 'logging',
  ...
  },
  {
    ...
    qualifierKey: L('sections.headers.claude_title'),
    hintKey: L('sections.headers.timezone_hint'),
    yamlKeys: ['claude-header-defaults', 'timezone'],
    keywords: ['claude', 'tz'],
  },
  {
    fieldId: 'disableClaudeCloakMode',
    sectionId: 'advanced',
    labelKey: L('sections.headers.disable_claude_cloak'),
    hintKey: L('sections.headers.disable_claude_cloak_desc'),
    yamlKeys: ['disable-claude-cloak-mode'],
    keywords: ['claude', 'cloak'],
  },
  {
    fieldId: 'xaiInjectXSearch',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.xai_inject_x_search'),
    hintKey: L('sections.advanced.xai_inject_x_search_desc'),
    yamlKeys: ['xai', 'inject-x-search'],
    keywords: ['xai', 'x_search'],
  },
  {
    fieldId: 'codexIdentityConfuse',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.codex_identity_confuse'),
    hintKey: L('sections.advanced.codex_identity_confuse_desc'),
    yamlKeys: ['codex', 'identity-confuse'],
    keywords: ['codex'],
  },
  {
    fieldId: 'codexStripIntermediaryUpdates',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.codex_strip_intermediary'),
    hintKey: L('sections.advanced.codex_strip_intermediary_desc'),
    yamlKeys: ['codex', 'strip-intermediary-updates'],
    keywords: ['codex'],
  },
  {
    fieldId: 'codexDisableCloaking',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.codex_disable_cloaking'),
    hintKey: L('sections.advanced.codex_disable_cloaking_desc'),
  ...
  },
  {
    ...
    sectionId: 'advanced',
    labelKey: L('sections.advanced.codex_stream_bootstrap'),
    hintKey: L('sections.advanced.codex_stream_bootstrap_desc'),
  ...
  },
  {
    ...
    sectionId: 'advanced',
    labelKey: L('sections.advanced.codex_stream_bootstrap_timeout'),
    hintKey: L('sections.advanced.codex_stream_bootstrap_timeout_hint'),
    yamlKeys: ['codex', 'stream-bootstrap-timeout'],
    keywords: ['codex'],
  },
  {
    fieldId: 'codexOptimizeMultiAgentV2',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.codex_optimize_multi_agent'),
    hintKey: L('sections.advanced.codex_optimize_multi_agent_desc'),
  ...
  },
  {
    ...
    sectionId: 'advanced',
    labelKey: L('sections.advanced.codex_orphan_delegation'),
    hintKey: L('sections.advanced.codex_orphan_delegation_desc'),
  ...
  },
  {
    ...
    sectionId: 'advanced',
    labelKey: L('sections.advanced.codex_model_level_cooling'),
    hintKey: L('sections.advanced.codex_model_level_cooling_desc'),
    yamlKeys: ['codex', 'model-level-cooling'],
    keywords: ['codex'],
  },
  {
